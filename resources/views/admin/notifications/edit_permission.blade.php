<div class="swal2-container swal2-rtl swal2-center swal2-backdrop-show" style="overflow-y: auto;">
    <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
        ...
        <div class="swal2-header">
            ...
            <div class="swal2-icon swal2-success" style="display: none;"></div><img class="swal2-image"
                style="display: none;">
            <h2 class="swal2-title" id="swal2-title" style="display: flex;">هل تريد ازالة هذه الصلاحية؟</h2><button
                type="button" class="swal2-close" style="display: none;" aria-label="Close this dialog">×</button>
        </div>
        <div class="swal2-content">
            <div id="swal2-content" class="swal2-html-container" style="display: none;"></div><input class="swal2-input"
        ...
        <div class="swal2-actions">
            <button type="button" class="swal2-confirm swal2-styled"
                ...
                aria-label="" wire:click="updatePermissionConfirm">
                OK
            </button>
            <button type="button" class="swal2-cancel swal2-styled" style="display: inline-block;"
                wire:click="updatePermissionCancel">
                Cancel
            </button>
        </div>
