    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.real_estate_owner') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="mobile_number" class="col-md-4 col-form-label text-md-right"> لرقم
                                الهاتف</label>
                        ...
                        <div class="form-group row">
                            <label for="mobile_number_country_code" class="col-md-4 col-form-label text-md-right">كود
                                الدولة رقم الهاتف </label>

                            <div class="col-md-6">
                                <input id="mobile_number_country_code" type="text"
                                    class="form-control @error('mobile_number_country_code') is-invalid @enderror"
                                    name="mobile_number_country_code" value="{{ old('mobile_number_country_code') }}"
                                    required autocomplete="mobile_number_country_code" autofocus>
