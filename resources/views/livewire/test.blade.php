                        ...
                        <div class="col-md-3">
                            <div class="form-body">
                                ...
                                @error('postal_code') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('postal_code') style="color: #F3565D"
                                        @enderror>الرمز
                                        البريدي</label>
                                    @error('postal_code')
                        ...
                        <div class="col-md-9">
                            <div class="form-body">
                                ...
                                @error('address') has-error @enderror">
                                    <input type="text" class="form-control" id="form_control_1"
                                        wire:model.defer="address" autocomplete="off">
                            ...
                            <div class="form-body ">
                                ...
                                @error('price') has-error @enderror">
                                    <span class="input-group-addon"
                                        style="border-radius: 0;background: none;border: 0;">₪</span>
                                    <input type="text" class="form-control" id="form_control_1"
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('discount_percent_when_cancel_book') has-error @enderror input-group">
                                    ...
                                    <span id="discount_percent_when_cancel_book-error"
                                        class="help-block help-block-error" style="color: #F3565D">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('length_in_meter') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('length_in_meter') style="color: #F3565D"
                                        @enderror>
                                        الطول بالمتر
                                    </label>
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('width_in_meter') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('width_in_meter') style="color: #F3565D"
                                        @enderror>
                                        العرض بالمتر
                                    </label>
                        ...
                        <div class="col-md-3">
                            <div class="form-body">
                                ...
                                @error('number_of_people') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('number_of_people') style="color: #F3565D"
                                        @enderror>
                        ...
                        <div class="col-md-4">
                            <div class="form-body ">
                                ...
                                @error('bedrooms_number') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('bedrooms_number') style="color: #F3565D"
                                        @enderror>
                                        عدد غرف النوم
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-body ">
                                ...
                                @error('bathroom_numbers') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('bathroom_numbers') style="color: #F3565D"
                                        @enderror>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div style="padding-right: 25px"
                                ...
                                <div class="md-radio-inline">
                                    <div class="md-radio">
                                        <input type="radio" id="pets_allow" name="pets_allow" class="md-radiobtn"
                                            value="1" wire:model="pets_allow">
                                    ...
                                    <div class="md-radio">
                                        <input type="radio" id="pets_allow2" name="pets_allow" class="md-radiobtn"
                                            value="0" wire:model="pets_allow">
                        ...
                        <div class="col-md-3">
                            <div style="padding-right: 25px"
                                ...
                                <div class="md-radio-inline">
                                    <div class="md-radio">
                                        <input type="radio" id="kids_allow" name="kids_allow" class="md-radiobtn"
                                            value="1" wire:model="kids_allow">
                                    ...
                                    <div class="md-radio">
                                        <input type="radio" id="kids_allow2" name="kids_allow" class="md-radiobtn"
                                            value="0" wire:model="kids_allow">
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('start_arrive_at') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('start_arrive_at') style="color: #F3565D"
                                        @enderror>
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('end_arrive_at') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('end_arrive_at') style="color: #F3565D"
                                        @enderror>
                        ...
                        <div class="col-md-3">
                            <div class="form-body ">
                                ...
                                @error('start_leave_at') has-error @enderror">
                                    ...
                                    <label for="form_control_1" @error('start_leave_at') style="color: #F3565D"
                                        @enderror>
