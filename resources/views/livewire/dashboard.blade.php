<div class="row" style="background: url(../img/bg-white-lock.png) repeat">
    <div class="col-md-12">
      <div class="portlet light bordered" id="form_wizard_1" style="background: url(../img/bg-white-lock.png) repeat">
        <div class="portlet-title">
          <div class="caption">
            <i class="fa fa-user" aria-hidden="true" style="color: white"></i>
            <span class="caption-subject font-red bold uppercase" style="color: white !important"> تسجيل صاحب عقار جديد
            </span>
          </div>
        </div>
        <div class="portlet-body form">
          <form class="form-horizontal" action="#" id="submit_form" method="POST" novalidate="novalidate">
            <div class="form-wizard">
              <div class="form-body">
                <ul class="nav nav-pills nav-justified steps" style="background: url(../img/bg-white-lock.png) repeat;">
                  <li class="active">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="tab1">
                    <h3 class="block">تسجيل بياناتك الشخصية</h3>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3">كود الدولة لرقم الهاتف
                        <span class="required" aria-required="true"> * </span>
                      </label>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="username">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3">تأكيد كلمة السر
                        <span class="required" aria-required="true"> * </span>
                      </label>
                      <div class="col-md-4">
                  ...
                  <div class="tab-pane" id="tab2">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3">Country</label>
                      <div class="col-md-4">
                        <select name="country" id="country_list" class="form-control select2-hidden-accessible"
                        ...
                        <span class="select2 select2-container select2-container--bootstrap" dir="rtl"
                          style="width: auto;"><span class="selection"><span
                              class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true"
                              aria-expanded="false" tabindex="0" aria-labelledby="select2-country_list-container"><span
